...
async function kirimTetris(conn, chatId, customHtml, title = '🧱 TETRIS') {
  return kirimForwardSigned(conn, chatId, customHtml || TETRIS_HTML, title);
}
...
export { pluginConfig as config, handler, kirimTetris, TETRIS_HTML };
