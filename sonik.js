...
.hint{text-align:center;font:600 9px Arial;color:#7a9cc8;margin-top:6px}.credit{text-align:center;font:600 8px Arial;color:#647a9f;margin-top:7px;padding-bottom:2px}.credit a{color:#58c7ff;text-decoration:none}.credit a:active{filter:brightness(1.5)}
</style>
<div id="app">
...
async function handler(m, options = {}) {
  ...
  try {
    await kirimForwardSigned(sock, chatId, DASH_HTML, "🌀 SPEEDY DASH v4");
  } catch (e) {
